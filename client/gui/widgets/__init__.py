...
class StatusBadge(QLabel):
    ...
    Usage:
        badge = StatusBadge("ðŸŸ¢ AMAN")
        badge.set_status("ðŸ”´ BAHAYA")
    """

    def __init__(self, status: str = "ðŸŸ¢ AMAN", parent: Optional[QWidget] = None):
        super().__init__(parent)
...
# ============================================================
# EXPORTS untuk package (biar from client.gui.widgets import X jalan)
# ============================================================
