...
import json
import pandas as pd
from datetime import datetime                    # ← FIX: pakai from-import
from threading import Lock

from server.auth.password import hash_password, verify_password  # ← pindah ke atas
...
def create_user(username: str, password: str,
    ...
    with _user_lock:
        ...
        new_user = {
            ...
            "role": role,
            "created_at": datetime.now().isoformat(timespec="seconds"),  # ← FIX
        }
